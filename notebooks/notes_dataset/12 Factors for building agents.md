> **Source:** [humanlayer/12-factor-agents — Factor 1 (GitHub)](https://github.com/humanlayer/12-factor-agents/blob/main/content/factor-1-natural-language-to-tool-calls.md)
